...
import FooterSectionsRender from "@/components/admin/footer-editor/FooterSectionsRender";
import usePart from "@/hooks/usePart";
import { TbNewSection } from "react-icons/tb";

export default function HomeSections() {
  const { part, setPart, changed, SaveButton } = usePart("FOOTER");
  const newSection = () => {
    setPart({
      ...part,
      ...
      <AdminPanelWrapper>
        <div className="top-0 sticky bg-gray-900 py-4 z-10">
          <div className="flex justify-between">
            <div>
              <h1 className="font-semibold text-xl">Footer Editor</h1>
            </div>
