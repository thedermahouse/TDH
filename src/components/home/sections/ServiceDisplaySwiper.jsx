...
export default function ServiceDisplaySwiper({ subServices, serviceName }) {
  ...
  // Check if we should show arrows based on subServices length
  useEffect(() => {
  ...
  return (
    <div className="w-full relative ">
      ...
      <div className="w-full ">
        <Swiper
          ...
          breakpoints={{
            ...
            1400: { slidesPerView: 2.7, spaceBetween: 20 },
          }}
          className="w-full"
        >
          {subServices
      ...
      {/* Show arrows only if more than 2 slides & desktop */}
      {showArrows && (
        <>
          <button
